...
{
public:
	typedef boost::signal<void (const std::wstring&, const std::wstring&, const DWORD, const std::wstring&, const std::wstring&, const std::wstring&)> signal_connectionEvent;
public:
	NetworkMonitor(void);
